                ...
                <div class="card-body">
                    ...
                    <form method="POST" action="{{ route('employees.update' ,$employee->id) }}">
                        ...
                        <div class="row mb-3">
                         ...
                         <select onChange=' ' id = 'department_id' name='department_id' class="form-select p-3 @error('department_id') is-invalid @enderror" aria-label="Default select example">
                            ...
                            <option value="{{ $dep->id }}" {{ $employee->department->id == $dep->id ? "selected" : "" }} >{{ $dep->name }} located in ({{ $dep->city->name }} / {{ $dep->city->country->name }})</option>    
                            @endforeach
                          </select>
                        </div>
                    </div>
